...
### 📊 项目概览
- 🏗️ **126 个公开仓库** - 涵盖工具链、数据、AI、多媒体等领域
- 📦 **20+ 活跃 PyPI 包** - 持续维护并发布到 Python 包索引
- 🌟 **100 GitHub Stars** - 获得社区认可
- 🧰 **两条产品线** - `nlt*` 基础工具链 + `fun*` 领域应用库
...
| [nltcache](https://github.com/farfarfun/nltcache) | 轻量函数缓存装饰器库，内存 / 磁盘 / Pickle 多种策略，原生支持 async | [![PyPI](https://img.shields.io/pypi/v/nltcache?style=flat-square)](https://pypi.org/project/nltcache/) |
...
| 项目 | 用途 | PyPI |
|------|------|------|
| [nltbuild](https://github.com/farfarfun/nltbuild) | 构建与发布：自动匹配 UV / Poetry / npm 策略，串联版本递增、发布与打标签 | [![PyPI](https://img.shields.io/pypi/v/nltbuild?style=flat-square)](https://pypi.org/project/nltbuild/) |
| [nltcache](https://github.com/farfarfun/nltcache) | 函数缓存装饰器：内存、磁盘与 Pickle 缓存 | [![PyPI](https://img.shields.io/pypi/v/nltcache?style=flat-square)](https://pypi.org/project/nltcache/) |
| [nltget](https://github.com/farfarfun/nltget) | HTTP 文件传输：并发、断点续传与命令行 | [![PyPI](https://img.shields.io/pypi/v/nltget?style=flat-square)](https://pypi.org/project/nltget/) |
| [nltfile](https://github.com/farfarfun/nltfile) | 文件、归档与序列化实用工具 | [![PyPI](https://img.shields.io/pypi/v/nltfile?style=flat-square)](https://pypi.org/project/nltfile/) |
| [nltsecret](https://github.com/farfarfun/nltsecret) | 本地密钥管理与可选的 MySQL 同步 | [![PyPI](https://img.shields.io/pypi/v/nltsecret?style=flat-square)](https://pypi.org/project/nltsecret/) |
| [nltlog](https://github.com/farfarfun/nltlog) | 基于 Loguru 的日志库：按名称拆分文件，按日轮转与压缩 | [![PyPI](https://img.shields.io/pypi/v/nltlog?style=flat-square)](https://pypi.org/project/nltlog/) |
| [nltdeploy](https://github.com/farfarfun/nltdeploy) | 快速部署环境的脚本集 | [![PyPI](https://img.shields.io/pypi/v/nltdeploy?style=flat-square)](https://pypi.org/project/nltdeploy/) |
...
|  3 | [nltbuild](https://github.com/farfarfun/nltbuild)   | <img alt="Stars" src="https://img.shields.io/github/stars/farfarfun/nltbuild?style=flat-square&labelColor=black"/>  | <img alt="Forks" src="https://img.shields.io/github/forks/farfarfun/nltbuild?style=flat-square&labelColor=black"/>  | <img alt="Watchers" src="https://img.shields.io/github/watchers/farfarfun/nltbuild?style=flat-square&labelColor=black"/>  | [![nltbuild](https://static.pepy.tech/personalized-badge/nltbuild?period=total&units=international_system&left_color=black&right_color=red&left_text=Downloads)](https://pepy.tech/project/nltbuild)    | ![nltbuild](https://img.shields.io/pypi/dm/nltbuild)   | ![PyPI - Version](https://img.shields.io/pypi/v/nltbuild)  | ![PyPI - Format](https://img.shields.io/pypi/format/nltbuild)  | [![PyPi](https://img.shields.io/badge/PyPi-black?style=flat-square&logo=pypi)](https://pypi.org/project/nltbuild)  |
...
|  6 | [nltget](https://github.com/farfarfun/nltget)       | <img alt="Stars" src="https://img.shields.io/github/stars/farfarfun/nltget?style=flat-square&labelColor=black"/>    | <img alt="Forks" src="https://img.shields.io/github/forks/farfarfun/nltget?style=flat-square&labelColor=black"/>    | <img alt="Watchers" src="https://img.shields.io/github/watchers/farfarfun/nltget?style=flat-square&labelColor=black"/>    | [![nltget](https://static.pepy.tech/personalized-badge/nltget?period=total&units=international_system&left_color=black&right_color=red&left_text=Downloads)](https://pepy.tech/project/nltget)          | ![nltget](https://img.shields.io/pypi/dm/nltget)       | ![PyPI - Version](https://img.shields.io/pypi/v/nltget)    | ![PyPI - Format](https://img.shields.io/pypi/format/nltget)    | [![PyPi](https://img.shields.io/badge/PyPi-black?style=flat-square&logo=pypi)](https://pypi.org/project/nltget)    |
...
# 例如安装近期维护的工具包
pip install fundrive funtable nltget nltcache
```
